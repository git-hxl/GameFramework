...
namespace GameFramework
{
    public class ObjectPoolExample : MonoBehaviour
    {
        ...
        void Start()
        {
            objectPoolCollection = ObjectPoolManager.Instance.CreateReferenceCollection("Cube", "Assets/GameFramework/Example/ObjectPool/Cube.prefab");
        }
        ...
        void Update()
        {
            ...
            {
                GameObject gameObject = ObjectPoolManager.Instance.Acquire("Cube");
