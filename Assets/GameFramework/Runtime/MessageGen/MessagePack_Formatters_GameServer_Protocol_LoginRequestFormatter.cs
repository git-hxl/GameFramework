...
{
    public sealed class LoginRequestFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::GameServer.Protocol.LoginRequest>
    {
        // Account
        ...
        public global::GameServer.Protocol.LoginRequest Deserialize(ref global::MessagePack.MessagePackReader reader, global::MessagePack.MessagePackSerializerOptions options)
        {
            ...
            var ____result = new global::GameServer.Protocol.LoginRequest();
            ...
            for (int i = 0; i < length; i++)
            {
                ...
                switch (stringKey.Length)
                {
                    ...
                    case 7:
                        ...
                        ____result.Account = global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<string>(formatterResolver).Deserialize(ref reader, options);
                        continue;
                    case 8:
