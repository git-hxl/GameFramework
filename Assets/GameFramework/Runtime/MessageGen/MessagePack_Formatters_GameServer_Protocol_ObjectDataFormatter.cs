...
{
    public sealed class ObjectDataFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::GameServer.Protocol.ObjectData>
    {
        // ObjectID
        private static global::System.ReadOnlySpan<byte> GetSpan_ObjectID() => new byte[1 + 8] { 168, 79, 98, 106, 101, 99, 116, 73, 68 };
        // AssetPath
        private static global::System.ReadOnlySpan<byte> GetSpan_AssetPath() => new byte[1 + 9] { 169, 65, 115, 115, 101, 116, 80, 97, 116, 104 };

        public void Serialize(ref global::MessagePack.MessagePackWriter writer, global::GameServer.Protocol.ObjectData value, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (value is null)
            {
                writer.WriteNil();
        ...
        public global::GameServer.Protocol.ObjectData Deserialize(ref global::MessagePack.MessagePackReader reader, global::MessagePack.MessagePackSerializerOptions options)
        {
            ...
            var ____result = new global::GameServer.Protocol.ObjectData();
